...
| 7 | Çekim arşivi, retake | in-progress | Gerçek oynanış çekimi CANLI doğrulandı: Safha 6'da üretilen gerçek ShotPlan'ın bir "gameplay" sahnesi için, aynı sahnedeki görsel operatör döngüsü (Safha 5) artık gerçek scrcpy kaydı altında çalışıyor — 34.7 saniyelik gerçek h264+opus MP4 üretildi, ffprobe ile bağımsız doğrulandı, teknik QC (probe/decode/sahne/boş-kare) 4/4 geçti, gerçek Asset+Take DB'ye yazıldı. Retake/attempt sayacı, kontrol-devri (takeover) durumunda kısmi kaydı reddedilmiş Take olarak saklama (silmeden) da doğrulandı. Henüz yok: çoklu take arasından seçim UI'ı, otomatik olay tespitiyle in/out kırpma |
